...
function Input() {
  ...
  const handleSelect = (placeId) => {
    const newLocation = locations.find(
      (location) => location?.place_id === placeId
    );
  ...
  const handleSearch = async () => {
    try {
      ...
      const { data } = await axios.get(`${locationApiBaseUrl}/${search}`, {
        params: {
          ...locationApiParams,
        },
      });
          ...
          <div className="search-results">
            {loadingSearch ? (
              ...
              <>
                ...
                <p>{!locations.length && notFound && notFound}</p>
              </>
            )}
          </div>
        </div>
            ...
            <>
              <div className="pop">
                <p>
                  Population year:
                  {location?.extratags
                    ? location?.extratags["census:population"] ||
                      "Not available"
                    : "Not available"}
                </p>
                ...
                <p>
                  Population :
                  {location?.extratags?.population || "Not available"}
                </p>
              </div>
